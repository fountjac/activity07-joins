...
**Response**: Yes, there are La Quinta's in Mexico
              No, Denny's is only in USA
...
**Response**: If we are matching the two places together we can join just on matches
